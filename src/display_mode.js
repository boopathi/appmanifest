...
export default function display_mode ({manifest, logger: _logger}) {
  ...
  if (typeof descriptor === "undefined") {
    logger.warn(`Display mode is empty. Using defaultDisplayMode - browser`);
    return "browser";
  }
  ...
  let supported = Object.keys(displayModeValues).indexOf(trimmedValue) !== -1;
